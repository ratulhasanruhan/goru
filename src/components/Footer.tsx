        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              {/* Peerlist Badge */}
              <a 
                href="https://peerlist.io/ratulhasan/project/gorusheba--iot--ai-farming" 
                target="_blank" 
                rel="noreferrer"
                className="hover:opacity-90 transition-opacity"
              >
                <img
                  src="https://peerlist.io/api/v1/projects/embed/PRJHDNDDKKQNBDBKM3LQJBDNJKDMMG?showUpvote=false&theme=light"
                  alt="GoruSheba - IoT & AI Farming"
              ...
              {/* Product Hunt Badge */}
              <a 
                href="https://www.producthunt.com/products/gorusheba?embed=true&utm_source=badge-featured&utm_medium=badge&utm_source=badge-gorusheba" 
                target="_blank"
                rel="noreferrer"
                className="hover:opacity-90 transition-opacity"
              >
                <img 
                  src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1031215&theme=light&t=1761738129365" 
                  alt="GoruSheba - The Future of Cattle Management | Product Hunt" 
                  style={{ width: 'auto', height: '54px' }} 
                />
              </a>
            </div>
