        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className={`text-gray-400 text-sm ${language === 'bn' ? 'font-bengali' : ''}`}>
              © 2025 <a href="https://appibrium.tech/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Appibrium</a>. All rights reserved.
            </p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link href="/privacy-policy" className={`text-gray-400 hover:text-white text-sm transition-colors ${language === 'bn' ? 'font-bengali' : ''}`}>
                {t('footer.privacy')}
              </Link>
              <Link href="/terms-of-service" className={`text-gray-400 hover:text-white text-sm transition-colors ${language === 'bn' ? 'font-bengali' : ''}`}>
                {t('footer.terms')}
              </Link>
            </div>
          </div>
